  ...
  module Model
    module Platform
      class TaskList < Base
        ...
        attribute :ends_at, on: [:create, :update], type: :date_time
        ...
        attribute :matching_configuration_id, on: [:create, :update], type: :string
        attribute :end_place_id, on: [:create, :update], type: :object, class_name: 'Place'
        ...
        attribute :starts_at, on: [:create, :update], type: :date_time
        attribute :start_place, on: :read, type: :object, class_name: 'Place'
        attribute :start_place_id, on: [:create, :update], type: :object, class_name: 'Place'
        ...
        attribute :vehicle_id, on: [:create, :update], type: :object, class_name: 'Vehicle'
      end
    end
  end
end
