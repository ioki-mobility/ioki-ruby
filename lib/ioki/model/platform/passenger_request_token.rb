  ...
  module Model
    module Platform
      class PassengerRequestToken < Base
        ...
        attribute :user,  type: :object,  on: :read, model_class: Ioki::Model::Platform::User, unvalidated: true # The model does not return it but it's used when sending data to the server.
