  ...
  module Model
    module Platform
      class Ride < Base
        ...
        attribute :origin,         type: :object,  on: [:create, :read], model_class: Ioki::Model::Platform::RequestedPoint
        attribute :destination,    type: :object,  on: [:create, :read], model_class: Ioki::Model::Platform::RequestedPoint
        attribute :passengers,     type: :array,   on: [:create, :read], model_class: Ioki::Model::Platform::RidePassenger
        ...
        attribute :dropoff_task, on: :read, type: :object, model_class: Ioki::Model::Platform::Task
        ...
        attribute :pickup_task, on: :read, type: :object, model_class: Ioki::Model::Platform::Task
        ...
        attribute :route, on: :read, type: :object, model_class: Ioki::Model::Platform::Route
