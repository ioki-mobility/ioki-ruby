  ...
  module Model
    module Driver
      class Leg < Base
        ...
        attribute :destination_task_calculated_time, on: :read, type: :date_time
        attribute :destination_task_waypoint_type, on: :read, type: :string
        attribute :distance, on: :read, type: :integer
        attribute :duration, on: :read, type: :integer
        attribute :geo_track, on: :read, type: :string
        attribute :geo_track_durations, on: :read, type: :array
